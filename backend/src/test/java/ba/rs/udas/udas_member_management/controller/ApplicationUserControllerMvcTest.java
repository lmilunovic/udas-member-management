...
class ApplicationUserControllerMvcTest {
    ...
    void listUsers_whenAdmin_returns200() throws Exception {
        ...
        given(userMapper.toModel(admin)).willReturn(ApplicationUserFixtures.applicationUserModelJohn());
    ...
    void getUser_whenAdmin_andExists_returns200() throws Exception {
        ...
        given(userMapper.toModel(user)).willReturn(ApplicationUserFixtures.applicationUserModelJohn());
    ...
    void getCurrentUser_withOidcLogin_returns200() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/users/me")
                        .with(oidcLogin().idToken(token ->
                                token.subject("google-sub-123").claim("email", "admin@example.com"))))
                .andExpect(status().isOk());
    }
